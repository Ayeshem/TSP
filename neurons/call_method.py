...
from graphite.solvers.app import SimulatedAnnealingSolver
...
async def simulated_annealing_solution(synapse):
    new_synapse = copy.deepcopy(synapse)
    route =  await  simulated_annealing.solve_problem(new_synapse.problem)
    new_synapse.solution = route
    return new_synapse